...
export const prop = <T, K extends keyof T>(key: K) => (obj: T): T[K] =>
  obj[key];
...
export const propResult = <T, K extends keyof T, E>(
  key: K, 
  onMissing: () => E
) => (obj: T): Result<E, T[K]> => {
...
export const pickResult = <T, K extends keyof T, E>(
  keys: K[], 
  onMissing: (missingKey: K) => E
...
export const omitResult = <T, K extends keyof T>(keys: K[]) => 
...
export const getPath = <T, E>(
  path: string[], 
  onMissing: (path: string) => E
